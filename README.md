...
Adds speech recognition to RevealJS for Quarto. This project ports the [mschmo/reveal-speech](https://github.com/mschmo/reveal-speech) plugin over to Quarto. Credit goes to [Matthew Schmoyer](https://github.com/mschmo) for the original plugin that I've made some slight modifications to. It allows you to verbally control your RevealJS slides.
